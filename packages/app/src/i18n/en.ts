export const dict = {
  ...
  "sidebar.project.pinned": "Pinned",
  "sidebar.project.projects": "Projects",
  "sidebar.project.pin": "Pin project",
  "sidebar.project.unpin": "Unpin project",
  "sidebar.project.openInExplorer": "Open in file explorer",
  "sidebar.project.rename": "Rename project",
  "sidebar.project.archiveConversations": "Archive conversations",
  ...
  "settings.general.row.layoutDesign.title": "Layout",
  "settings.general.row.layoutDesign.description": "Choose the desktop layout style",
  "settings.general.row.layoutDesign.option.classic": "Classic",
  "settings.general.row.layoutDesign.option.modern": "New layout and designs",
  "settings.general.row.layoutDesign.option.codex": "Codex style",
