...
export const dict = {
  ...
  "session.child.promptDisabled": "子代理程式工作階段不能輸入提示。",
  ...
  "home.sessions.search.noResults": "未找到與 {{query}} 相關的工作階段",
  "home.sessions.empty": "未找到工作階段",
  ...
  "session.review.noUncommittedChanges": "暫無未提交變更",
  ...
  "sidebar.empty.description": "開啟一個專案即可開始",
  ...
  "sidebar.project.pinned": "釘選",
  "sidebar.project.projects": "專案",
  "sidebar.project.pin": "釘選專案",
  "sidebar.project.unpin": "取消釘選專案",
  "sidebar.project.openInExplorer": "在檔案總管中開啟",
  "sidebar.project.rename": "重新命名專案",
  "sidebar.project.archiveConversations": "封存對話",
  ...
  "settings.general.row.layoutDesign.title": "版面配置",
  "settings.general.row.layoutDesign.description": "選擇桌面端版面風格",
  "settings.general.row.layoutDesign.option.classic": "經典版面",
  "settings.general.row.layoutDesign.option.modern": "新版面與設計",
  "settings.general.row.layoutDesign.option.codex": "Codex 風格",
  "settings.general.row.showFileTree.title": "檔案樹",
  "settings.general.row.showFileTree.description": "在桌面端工作階段中顯示檔案樹面板",
  "settings.general.row.showNavigation.title": "導覽控制項",
  "settings.general.row.showNavigation.description": "在桌面端標題列中顯示上一頁和下一頁按鈕",
  "settings.general.row.showSearch.title": "命令面板",
  "settings.general.row.showSearch.description": "在桌面端標題列中顯示搜尋與命令面板按鈕",
  "settings.general.row.showTerminal.title": "終端機",
  "settings.general.row.showTerminal.description": "在桌面端標題列中顯示終端機按鈕",
  "settings.general.row.showStatus.title": "伺服器狀態",
  "settings.general.row.showStatus.description": "在桌面端標題列中顯示伺服器狀態按鈕",
  "settings.general.row.showCustomAgents.title": "自訂代理程式",
  "settings.general.row.showCustomAgents.description": "在 v2 桌面端輸入框中顯示代理程式選擇器",
  "settings.general.row.newLayoutDesigns.title": "新版面與設計",
  "settings.general.row.newLayoutDesigns.description": "啟用重新設計的版面、首頁、輸入框和工作階段介面",
  ...
  "titlebar.update.version": "更新到 {{version}}",
  ...
  "settings.permissions.tool.glob.title": "檔案匹配",
  "settings.permissions.tool.glob.description": "使用 glob 模式符合檔案",
  "settings.permissions.tool.grep.title": "內容搜尋",
  ...
  "settings.permissions.tool.doom_loop.title": "死循環",
