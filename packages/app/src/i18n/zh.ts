...
export const dict = {
  ...
  "session.child.promptDisabled": "子智能体会话不能输入提示。",
  ...
  "session.review.noUncommittedChanges": "暂无未提交更改",
  ...
  "settings.general.row.layoutDesign.title": "布局",
  "settings.general.row.layoutDesign.description": "选择桌面端布局风格",
  "settings.general.row.layoutDesign.option.classic": "经典布局",
  "settings.general.row.layoutDesign.option.modern": "新布局和设计",
  "settings.general.row.layoutDesign.option.codex": "Codex 风格",
  "settings.general.row.showFileTree.title": "文件树",
  "settings.general.row.showFileTree.description": "在桌面端会话中显示文件树面板",
  "settings.general.row.showNavigation.title": "导航控件",
  "settings.general.row.showNavigation.description": "在桌面端标题栏中显示后退和前进按钮",
  "settings.general.row.showSearch.title": "命令面板",
  "settings.general.row.showSearch.description": "在桌面端标题栏中显示搜索和命令面板按钮",
  "settings.general.row.showTerminal.title": "终端",
  "settings.general.row.showTerminal.description": "在桌面端标题栏中显示终端按钮",
  "settings.general.row.showStatus.title": "服务器状态",
  "settings.general.row.showStatus.description": "在桌面端标题栏中显示服务器状态按钮",
  "settings.general.row.showCustomAgents.title": "自定义智能体",
  "settings.general.row.showCustomAgents.description": "在 v2 桌面端输入框中显示智能体选择器",
  ...
  "settings.permissions.tool.glob.title": "文件匹配",
  "settings.permissions.tool.glob.description": "使用 glob 模式匹配文件",
  "settings.permissions.tool.grep.title": "内容搜索",
